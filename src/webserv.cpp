...
+--------------------------------------------------+
|                 Port Numbers                      |
| (e.g., 80 - HTTP, 443 - HTTPS, 53 - DNS, etc.)    |
+--------------------------------------------------+
...
|                           Ethernet Frame                          |
+------------------------------------------------------------------+
| Destination MAC | Source MAC | EtherType (IPv4/IPv6) | Payload  |
+------------------------------------------------------------------+
                |
+------------------------------------------------------------------+
|                            IP Header                              |
+------------------------------------------------------------------+
| Version |  IHL  |    DSCP   | ECN |    Total Length (Bytes)      |
+------------------------------------------------------------------+
...
+------------------------------------------------------------------+
|      Window Size (Bytes)     |     Checksum   | Urgent Pointer  |
+------------------------------------------------------------------+
